...
<footer>
  <div class="container">
    <div class="row p-3">
      <div class="col-md-5">
        <img class="img-f foot-marg" src="{{asset('images/KonnectUsLogowhite.png')}}">
        <p class="text-white img-f mt-2">Lorem Ipsum is simply dummy text of the printing<br> and typesetting industry. Lorem ipsum has been<br> the industry's</p>
      </div>
      <div class="col-md-5 ">
...
<div class="copyright-div pt-3 pb-2" style="background-color: black;">
  <div class="container">
      <p class="text-white text text-capitalize">@ Konnect Us 2020. All rights reserved</p>
</div>