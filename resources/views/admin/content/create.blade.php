        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    @if(isset($content))
                        {{ Form::model($content,['method'=>'post','route' => ['content_settings.store'] , 'class' => 'js-form', 'enctype' => 'multipart/form-data']) }}
                    @else
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        <button type="submit"  class="btn bg-blue ml-3 w-25">Save </button>
                    </div>
...
new window.JustValidate('.js-form', {
    ...
    $("form").submit(function (e) {
        ...
        let error1  = $( this ).find( "p.error1" )
        let error2  = $( this ).find( "p.error2" )
        $(error).parents('div.card').css({'border':'1px solid rgb(184, 17, 17)','background-color':'rgb(255, 223, 223)'})
        $(error1).parents('div.card').css({'border':'1px solid rgb(184, 17, 17)','background-color':'rgb(255, 223, 223)'})
        $(error2).parents('div.card').css({'border':'1px solid rgb(184, 17, 17)','background-color':'rgb(255, 223, 223)'})
