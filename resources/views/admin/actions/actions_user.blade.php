@if(isset($user))
    ...
    <div class="btn-group" role="group" aria-label="Basic example">
        ...
        <a href="javascript:sdelete('admin/users/{{$user->id}}')" title="Suspend User" class="delete-row delete-color" data-id="{{ $user->id }}"><i class="icon-bin mr-1 icon-1x" style="color:red;"></i></a>
