...
@section('title', 'Update Pending Place')
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($place)) ? 'Update' : 'Add'}} Pendgin Place </h6>
                                        ...
                                        <div class="card-body">
                                            @if(isset($place))
                                                {{ Form::model($place,['method'=>'put','route' => ['pending_places.update',$place->id],'enctype' => 'multipart/form-data' , 'class' => 'js-form']) }}
                                            @else
                                                {{ Form::open(['route' => 'pending_places.store' ,'enctype' => 'multipart/form-data' , 'class' => 'js-form'] ) }}
                                            @endif
                                            <div class="row">
                                                <div class="col">
