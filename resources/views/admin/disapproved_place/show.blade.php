...
@section('title', 'Denied Location Details')
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <h4 class="d-inline">{{$place->user->name}}</h4>
                                                    ...
                                                    <p class="place-id d-none" >{!!$place->id!!}</p>
                                                </div>
                                            </div>
                                            <hr>
											<div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                	<h4>
                                                		Denied
                                                		&nbsp; &nbsp; &nbsp;
                                                		<a href="{{ route('disapproved_places.edit', [$place->id]) }}" title="Change Status"><i class="icon-pencil5 mr-1 icon-1x"></i></a>
                                                	</h4>
                                                </div>
                                            </div>
                                            <hr>
...
$(document).ready(function(){
    ...
    $(document).on('click', '.open-note-modal', function(){
       ...
       let place_id = $( this ).parents('div').find('p.place-id').text();
