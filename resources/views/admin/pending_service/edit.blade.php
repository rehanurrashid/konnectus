...
@section('title', 'Update Pending Service')
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($service)) ? 'Update' : 'Add'}} Pending Service </h6>
                                        ...
                                        <div class="card-body">
                                            @if(isset($service))
                                                {{ Form::model($service,['method'=>'put','route' => ['pending_services.update',$service->id],'enctype' => 'multipart/form-data' , 'class' => 'js-form']) }}
                                            @else
                                                {{ Form::open(['route' => 'pending_services.store' ,'enctype' => 'multipart/form-data' , 'class' => 'js-form'] ) }}
                                            @endif
                                            <div class="row">
                                                <div class="col">
