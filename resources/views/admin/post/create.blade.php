                                ...
                                <div class="col">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @else
                                                {{ Form::open(['route' => 'posts.store' ,'enctype' => 'multipart/form-data', 'class' => 'js-form'] ) }}
                                            @endif
                                            <div class="row">
                                                <div class="col">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::file('photo',array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Select Image','data-validate-field' => 'image')) }}
